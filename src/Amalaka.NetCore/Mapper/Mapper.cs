...
public static class Mapper
{
    ...
    public static Expression<Func<TSource, TResult>> Map<TSource, TResult>() where TSource : class where TResult : class
    {
    ...
    public static Expression<Func<TSource, TInner, TResult>> Map<TSource, TInner, TResult>() where TSource : class where TInner : class where TResult : class
    {
    ...
    public static TResult Map<TSource, TResult>(this TSource source) where TSource : class where TResult : class
        => Map<TSource, TResult>().Compile().Invoke(source);

    public static TResult Map<TSource, TInner, TResult>(this TSource source, TInner inner) where TSource : class where TInner : class where TResult : class
        => Map<TSource, TInner, TResult>().Compile().Invoke(source, inner);
